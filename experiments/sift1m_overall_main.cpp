...
int main() {
    ...
    if (dim_base != dim_query) { cerr << "Dimension Mismatch!" << endl; return -1; }
    ...
    cout << "\n=================================================================" << endl;
    cout << "   Self-Decision Adaptive Strategies Evaluation" << endl;
    cout << "=================================================================" << endl;
    ...
    // ---------------------------------------------------------
    cout << "\n[Strategy : Proxy-Metric Soft Barrier Penalty]" << endl;
    ...
    for (float t : target_recalls) {
        ...
        for (int i = 0; i < num_test; ++i) {
            auto res = index.SearchIterative_Strategy_final(data_query + i * dim_query, K, epsilon, t);
